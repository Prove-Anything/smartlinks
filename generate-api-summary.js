...
function generateAPISummary() {
  ...
  summary += '- **[Assets](assets.md)** - Asset object, AssetRef, upload, replace, soft-delete, restore, bulk-delete, and public token-based uploads\n';
  ...
  summary += '- **[Building React Components](building-react-components.md)** - Foundational guide to building React widgets and containers for SmartLinks\n';
  summary += '- **[Containers](containers.md)** - Building full-app embeddable containers (lazy-loaded)\n';
  summary += '- **[Mobile Admin Container](mobile-admin-container.md)** - Building mobile-optimised operator/admin containers as a separate bundle\n';
  summary += '- **[Container Tracking](container-tracking.md)** - Hierarchical physical/logical container groupings with item membership\n';
  ...
  summary += '- **[Native Facade](native-facade.md)** - Contract layer for accessing device capabilities (share, NFC, haptics) across host shells\n';
  ...
  summary += '- **[Portal Request Login](portal-request-login.md)** - Sub-apps delegate user authentication to the portal; `useSafeAuth().requestLogin` hook and iframe postMessage contract, redirect-bounce handling\n';
  summary += '- **[Portal Auth Broadcast](portal-auth-broadcast.md)** - Publishing a custom-flow session to the portal so the header, sibling apps, and SDK all stay in sync\n';
  summary += '- **[Portal Request Action](portal-request-action.md)** - Invoking portal built-in actions (`__qrScanner`, `__share`, `__logout`, etc.) from containers, widgets, and iframes\n';
  summary += '- **[Portal Back Button](portal-back-button.md)** - `parentPath` contract for hierarchy-aware "up" navigation; `useDeepLinkSync` integration\n';
  ...
  const groups = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'contact', desc: 'Manage customer contacts; CRUD, lookup, upsert, erase, and admin search.', docsLink: 'contact-search.md' },
      ]
    },
    {
